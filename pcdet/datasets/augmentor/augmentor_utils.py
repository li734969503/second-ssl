...
def random_flip_along_x(gt_boxes, points, return_flip=False, enable_=None):
    """
    Args:
...
def random_flip_along_y(gt_boxes, points, return_flip=False, enable_=None):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C)
...
def global_rotation(gt_boxes, points, rot_range, return_rot=False, rot_angle_=None):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C),
...
def global_scaling(gt_boxes, points, scale_range, return_scale=False, scale_=None):
    """
    Args:
